    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 py-12 px-4 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-10">
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          ...
          <span className="text-xs font-mono text-rose-400 flex items-center gap-1.5 bg-rose-500/10 px-3 py-1 rounded-full border border-rose-500/20">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-white leading-tight">
            {isHi ? (
              <>Sewa Ke Niyam. <br /><span className="bg-gradient-to-r from-rose-400 to-amber-300 bg-clip-text text-transparent">Insaniyat Ke Liye 100% Nishulk.</span></>
            ) : (
              <>Terms of Service. <br /><span className="bg-gradient-to-r from-rose-400 to-amber-300 bg-clip-text text-transparent">Built for Community, Free for All.</span></>
            )}
          </h1>
