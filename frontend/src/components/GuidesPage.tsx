          ...
          <div className="space-y-8">
            ...
            <div className="pt-8 border-t border-slate-800 flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 py-3.5 bg-rose-600 hover:bg-rose-700 text-white rounded-xl font-bold text-xs tracking-wide transition-all shadow-lg text-center cursor-pointer"
              >
