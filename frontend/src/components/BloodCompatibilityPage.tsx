      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="pt-4 flex flex-col sm:flex-row gap-4">
          <button
            ...
            className="flex-1 py-4 bg-rose-600 hover:bg-rose-700 text-white rounded-xl font-extrabold text-sm transition-all shadow-lg text-center cursor-pointer"
          >
            {isHi ? 'रक्तदाता के रूप में पंजीकरण करें →' : 'Register as Volunteer Donor →'}
          </button>
          <button
            onClick={() => onNavigate('request')}
            className="flex-1 py-4 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white rounded-xl font-extrabold text-sm transition-all shadow-lg text-center cursor-pointer"
          >
