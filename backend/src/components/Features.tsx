...
const features = [
  {
    ...
    desc: "Sub-second matching against verified donors. Considers blood group, 90-day eligibility, location, and donation history.",
    span: "lg:col-span-2",
  ...
  {
    icon: ShieldCheck,
    title: "90-day safety cooldown",
    desc: "Automatic eligibility windows so donors can never be over-notified. Compliance-grade audit logs included.",
    span: "lg:col-span-1",
  ...
  },
  {
    ...
    desc: "Your data is not our product. We keep no permanent records of donors or requesters. Once a match is safely concluded and cooldowns expire, data goes away.",
    span: "lg:col-span-1",
    accent: "from-emerald-50 to-white",
  },
];
        ...
        >
          <div>
            ...
            <h2 className="mt-2 text-[clamp(1.85rem,4.5vw,3rem)] font-medium leading-[1.05] tracking-tight text-ink-900">
              Every feature earns its place in the chain of survival.
            </h2>
          </div>
