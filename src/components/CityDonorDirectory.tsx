...
export function CityDonorDirectory({ initialZone, initialBloodGroup, onNavigate }: CityDonorDirectoryProps) {
 ...
 const constraints: any[] = [where('pincode', 'in', pincodeList)];
 if (selectedBloodGroup !== 'ALL') {
 constraints.push(where('blood_group', '==', selectedBloodGroup));
 }
 const q = query(collection(db, 'donor_profiles'), ...constraints);
...
>
 ...
 className="px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-xl font-bold text-xs tracking-wide transition-all flex items-center justify-center gap-2 cursor-pointer flex-shrink-0"
>
 ...
 className="px-5 py-2.5 bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white rounded-xl font-bold text-xs tracking-wide transition-all flex items-center justify-center gap-2 cursor-pointer flex-shrink-0"
>
...
>
 ...
 <button
 onClick={() => onNavigate('auth-signup')}
 className="p-5 bg-gradient-to-r from-rose-600 to-rose-800 hover:from-rose-700 hover:to-rose-900 text-white rounded-2xl font-bold text-sm transition-all flex items-center justify-between group cursor-pointer"
>
 ...
 <button
 onClick={() => onNavigate('request')}
 className="p-5 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white rounded-2xl font-bold text-sm transition-all flex items-center justify-between group cursor-pointer"
>
 <div className="text-left space-y-1">
