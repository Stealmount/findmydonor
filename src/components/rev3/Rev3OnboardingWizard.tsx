        ...
        <AnimatePresence mode="wait">
          {step === 'basic' ? (
            <motion.form
              ...
              className="glass p-6 sm:p-8 rounded-2xl space-y-5 border border-white/60 shadow-xl"
            >
              {/* Full Name */}
              <div>
              ...
              <div>
                ...
                <p className="text-[11px] text-ink-400 mt-1">
                  Used for urgent donor notifications and match alerts.
                </p>
              </div>
                    ...
                    <button
                      ...
                      className={`h-10 rounded-xl text-xs font-bold transition border ${
                        notificationChannel === opt.id
                          ? 'bg-blood-500 border-blood-600 text-white shadow-sm'
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full h-12 rounded-xl bg-gradient-to-r from-blood-600 to-blood-700 text-white font-bold text-sm shadow-md hover:from-blood-700 hover:to-blood-800 transition flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {submitting ? (
            ...
            <motion.form
              ...
              className="glass p-6 sm:p-8 rounded-2xl space-y-6 border border-white/60 shadow-xl"
            >
              ...
              <div className="pt-2 flex items-center gap-3">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 h-12 rounded-xl bg-gradient-to-r from-blood-600 to-blood-700 text-white font-bold text-sm shadow-md hover:from-blood-700 hover:to-blood-800 transition flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {submitting ? (
                    <Loader2 className="h-4 w-4 animate-spin" />
                  ) : (
