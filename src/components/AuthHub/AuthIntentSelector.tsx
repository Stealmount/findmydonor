...
export default function AuthIntentSelector({ onIntentSelected, loading: externalLoading }: AuthIntentSelectorProps) {
 ...
 return (
 <div className="w-full max-w-md rounded-3xl bg-white/95 border border-white/40 p-6 sm:p-8">
 <div className="text-center mb-6">
 <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-blood-50 text-blood-600 border border-blood-200/60">
 ...
 ? 'border-blood-600 bg-blood-50/60 text-blood-900 ring-2 ring-blood-500/20'
...
>
 ...
 className="mt-6 flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blood-600 to-blood-700 text-sm font-bold text-white disabled:opacity-40 cursor-pointer disabled:cursor-not-allowed transition-all"
>
