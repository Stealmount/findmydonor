...
export default function HospitalMap({
 ...
 <div class="relative bg-rose-600 border-2 border-white rounded-full p-2 text-white flex items-center justify-center w-8 h-8">
 🏥
 </div>
 </div>
 `,
 ...
 className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs transition-all active:scale-[0.98]"
 >
 🗺️ Get Directions
 </a>
 </div>
