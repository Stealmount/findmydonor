...
export function StatCard({ icon, label, value, tone = 'blood', isHi }: {
  ...
  return (
    <div className="rounded-2xl border border-ink-800 bg-ink-900/60 backdrop-blur-xl p-4 sm:p-5 flex items-center gap-4 shadow-premium-lg">
      ...
      <AnimatePresence>
        {toasts.map(t => (
          <motion.div
            ...
            className={`rounded-xl border bg-ink-900/95 backdrop-blur px-4 py-3 text-xs font-medium shadow-premium-lg ${styles[t.kind]}`}
          >
