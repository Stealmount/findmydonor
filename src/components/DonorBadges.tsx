...
export const BADGE_TIERS: BadgeTier[] = [
 ...
 color: 'from-amber-500/10 to-amber-500/20 text-amber-800 border-amber-300',
 ...
 color: 'from-purple-500/10 to-purple-600/30 text-purple-900 border-purple-300',
...
export default function DonorBadges({ donationCount }: DonorBadgesProps) {
 ...
 return (
 <div className="bg-white rounded-3xl p-6 border border-ink-200/80 space-y-6">
 ...
 <div className={`p-3 rounded-2xl bg-white flex items-center justify-center border-2 border-white/20`}>
 {currentTier.icon}
 </div>
