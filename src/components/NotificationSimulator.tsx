      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 w-full sm:w-[460px] bg-white/95 backdrop-blur-2xl border-l border-ink-200/80 text-ink-900 z-50 flex flex-col shadow-2xl"
          >
            {/* Header */}
            ...
            <AnimatePresence>
              {congratsMatch && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -20 }}
                  className="bg-emerald-500 text-white p-4 border-b border-emerald-600 flex flex-col items-center text-center shadow-lg relative overflow-hidden"
                >
              ...
              {filteredNotifs.length === 0 ? (
                ...
                filteredNotifs.map((notif) => {
                  ...
                  if (notif.trigger_event === 'donor_approved' && activeTab === 'congrats') {
                    ...
                    return (
                      <div key={notif.id} className="rounded-2xl bg-emerald-50 border border-emerald-200 p-4 shadow-sm space-y-2">
                  ...
                  return (
                    <div key={notif.id} className="rounded-2xl bg-white border border-ink-200/80 p-4 shadow-sm hover:shadow-md transition-shadow space-y-3">
                        ...
                        <div className="pt-3 border-t border-ink-100 space-y-2.5">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="flex-1 py-2 px-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
                            >
