...
export function HospitalHeader({
 ...
 return (
 <header className="sticky top-0 z-20 border-b border-ink-800 bg-ink-950/80 px-4 sm:px-8 py-3.5 flex items-center justify-between gap-4">
 <div className="flex items-center gap-3 min-w-0 flex-1">
 <div className="w-10 h-10 rounded-lg bg-ink-900 border border-ink-700 flex items-center justify-center shrink-0">
 ...
 className={`rounded-full px-2.5 py-1 text-xs font-bold transition-all cursor-pointer ${language === lang ? 'bg-blood-600 text-white' : 'text-ink-400 hover:text-white'}`}
>
 {lang}
 </button>
 ))}
