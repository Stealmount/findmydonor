...
export function Footer({ onNavigate }: FooterProps) {
 ...
 <div className="grid h-9 w-9 place-items-center rounded-xl blood-drop-gradient">
 ...
 <button
 onClick={item.action}
 className="text-left text-[13.5px] text-white/80 hover:text-white transition cursor-pointer"
 >
 {item.label}
 </button>
 </li>
