...
export function Navbar({ onNavigate }: NavbarProps) {
 ...
 scrolled
 ? "glass border border-ink-200/50"
 : "bg-white/90 border border-ink-200/60"
 }`}
 >
 <button
 onClick={() => {
 ...
 className="absolute top-full left-0 mt-2 w-56 rounded-2xl bg-white/95 border border-ink-200/80 p-2 z-50"
 >
 <button
 ...
 className="rounded-full px-4 py-1.5 text-xs xl:text-[13.5px] font-bold text-white bg-blood-600 hover:bg-blood-700 transition-all cursor-pointer whitespace-nowrap flex items-center gap-1.5"
 >
 ...
 className="absolute top-16 left-3 right-3 rounded-2xl glass shadow-p-3 lg:hidden bg-white/95 border border-ink-200 max-h-[85vh] overflow-y-auto"
 >
 ...
 <button
 onClick={() => { setOpen(false); onNavigate('request'); }}
 className="mt-2 flex w-full items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-blood-600 to-blood-700 py-3 text-sm font-bold text-white active:scale-95 transition"
 >
