...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
 ...
 className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 border-t border-ink-200/80 px-2 py-1.5 pb-safe"
 >
 ...
 >
 <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blood-500 to-blood-600 text-white flex items-center justify-center group-active:scale-95 transition-transform border-2 border-white">
