...
export function FAQPage({ onNavigate }: FAQPageProps) {
 ...
 <span className="text-xs font-bold text-emerald-700 bg-emerald-50/80 px-3.5 py-1.5 rounded-full border border-emerald-200 flex items-center gap-1.5">
 ...
 className="w-full bg-white border border-ink-200 rounded-2xl py-3 pl-11 pr-4 text-sm text-ink-900 focus:outline-none focus:border-blood-500 focus:ring-2 focus:ring-blood-500/20 transition-all placeholder:text-ink-400"
 />
 </div>
 ...
 ? 'bg-blood-600 text-white border-blood-600 shadow-blood-600/20'
 ...
 {/* Accordion List */}
 <div className="divide-y divide-ink-100 rounded-3xl bg-white subtle-border overflow-hidden">
 ...
 <div className="glass border border-ink-200/60 rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
