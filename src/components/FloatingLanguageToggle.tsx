...
export function FloatingLanguageToggle() {
 ...
 className="fixed bottom-20 left-4 sm:bottom-6 sm:left-6 z-50 flex items-center gap-1.5 p-1.5 rounded-full bg-ink-950/90 backdrop-blur-md border border-ink-800/80 hover:border-blood-500/60 transition-all group"
>
 ...
 !isHi
 ? 'bg-blood-600 text-white scale-105'
