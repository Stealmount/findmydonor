...
>
 ...
 <div className="bg-rose-50/80 border border-rose-100 p-6 rounded-2xl text-rose-950 space-y-2">
 ...
 {noticeMessage && (
 <div className="bg-amber-50 border border-amber-200 text-amber-900 p-4 rounded-xl text-xs flex items-start gap-3 animate-fadeIn">
 ...
 <div className="md:col-span-7 bg-white border border-gray-200 rounded-2xl p-6 space-y-5 flex flex-col justify-between">
...
>
 ...
 className="w-full py-3.5 rounded-xl bg-rose-600 hover:bg-rose-700 active:scale-[0.99] text-white font-bold text-xs transition-all flex items-center justify-center gap-2 cursor-pointer"
>
 ...
 <div className="md:col-span-5 bg-white border border-gray-200 rounded-2xl p-6 text-center flex flex-col items-center justify-center space-y-4">
 <div className="space-y-1">
 ...
 <div className="p-3 bg-white rounded-xl border border-gray-200 transition-all hover:scale-105">
 <img
 src="/bhim-qr.png"
 onError={(e) => {
 ...
 <div className="p-5 rounded-2xl bg-white border border-gray-200 text-xs text-gray-600 flex flex-col sm:flex-row items-center justify-between gap-3">
