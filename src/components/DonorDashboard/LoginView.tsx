...
export default function LoginView({ onNavigate }: LoginViewProps) {
 ...
 return (
 <div id="donor-login-container" className="max-w-md mx-auto rounded-3xl bg-white/95 border border-ink-200/80 shadow-overflow-hidden my-8">
 ...
 className="w-full h-12 rounded-xl bg-gradient-to-r from-blood-600 to-blood-700 hover:from-blood-500 hover:to-blood-600 text-white font-semibold text-sm shadow-blood-600/25 transition-all cursor-pointer flex items-center justify-center gap-2"
 >
