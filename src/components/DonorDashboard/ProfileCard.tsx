  ...
  return (
    <>
      ...
      <div className="rounded-[36px] bg-gradient-to-b from-blood-600 to-blood-700 p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <button
            ...
            className="p-3 rounded-2xl bg-white/10 text-red-200 hover:bg-red-500/20 transition-colors cursor-pointer shadow-lg ring-1 ring-white/20"
      ...
      {(!user.profile_complete || !user.blood_type || !user.pincode) && (
        <div className="rounded-3xl bg-amber-500/10 border border-amber-500/30 p-6 sm:p-7 text-ink-900 relative overflow-hidden shadow-premium">
      ...
      <div className="rounded-3xl bg-white/95 backdrop-blur-2xl border border-ink-200/80 p-6 sm:p-7 shadow-premium relative overflow-hidden">
        <div className="flex items-center justify-between border-b border-ink-100 pb-4 mb-5">
          <div className="flex items-center gap-3">
            <div className="grid h-10 w-10 place-items-center rounded-2xl blood-drop-gradient text-white shadow-md">
