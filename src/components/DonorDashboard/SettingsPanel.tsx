...
export default function SettingsPanel(props: SettingsPanelProps) {
 ...
 {/* Edit settings */}
 <div className="rounded-[32px] bg-gradient-to-b from-blood-600 to-blood-700 p-6 sm:p-7 space-y-4">
 ...
 <div className="absolute z-50 left-0 right-0 max-h-48 overflow-y-auto rounded-2xl bg-white border border-ink-200 mt-1.5 divide-y divide-ink-100">
 ...
 className="w-full py-3.5 rounded-2xl bg-white text-blood-700 font-semibold text-[13px] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 hover:bg-white/90 mt-2"
 >
...
export function CompleteProfileModal(props: {
 ...
 >
 <div className="w-full max-w-xl max-h-[90vh] overflow-y-auto rounded-3xl bg-white border border-ink-200 shadow-p-6 sm:p-8 space-y-6 relative text-ink-900">
 <button
 ...
 <div className="grid h-12 w-12 place-items-center rounded-2xl blood-drop-gradient text-white shadow-blood-600/30">
 ...
 type="submit"
 disabled={props.savingProfile}
 className=" w-full py-3.5 rounded-xl bg-blood-600 hover:bg-blood-700 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
 >
 <Save className="w-4 h-4" />
...
function ContactInfoSection({ phone, whatsappPhone }: { phone: string | null; whatsappPhone: string | null }) {
 ...
 className="w-full py-3.5 rounded-2xl bg-white text-blood-700 font-semibold text-[13px] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 hover:bg-white/90"
 >
 <Save className="w-4 h-4" />
