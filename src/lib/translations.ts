...
export const translations: Record<Language, TranslationDictionary> = {
  EN: {
    ...
    auth: {
      ...
      requesterCardTag: 'Emergency SOS',
    ...
    howItWorks: {
      ...
      step2Desc: 'Eligible donors who have completed their safety cooldown receive real-time SOS alerts with hospital directions.',
  ...
  HI: {
    ...
    auth: {
      ...
      requesterCardTag: 'आपातकालीन SOS',
    ...
    howItWorks: {
      ...
      step2Desc: 'पात्र रक्तदाता जिन्होंने अपनी सुरक्षा अवधि पूरी कर ली है, उन्हें अस्पताल के पते के साथ रीयल-टाइम SOS अलर्ट प्राप्त होते हैं।',
